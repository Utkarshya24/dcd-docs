...
To configure a workload with **TCP Proxy**, set the `protocol` field to `tcp` in your workload form.
...
<img height="200" src="images/db-mongo-form.png" />  
...
<img height="200" src="images/db-pg-form.png" />

Mysql Example
<img height="200" src="images/db-mysql-form.png" />   
